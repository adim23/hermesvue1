    ...
    if (this.citizensRelations.id) {
      this.citizensRelationsService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('hermesvue1App.citizensRelations.updated', { param: param.id });
      ...
      this.citizensRelationsService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('hermesvue1App.citizensRelations.created', { param: param.id });
