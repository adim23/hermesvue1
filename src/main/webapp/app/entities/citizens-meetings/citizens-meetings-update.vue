  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="hermesvue1App.citizensMeetings.home.createOrEditLabel"
          data-cy="CitizensMeetingsCreateUpdateHeading"
          v-text="$t('hermesvue1App.citizensMeetings.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('hermesvue1App.citizensMeetings.meetDate')" for="citizens-meetings-meetDate"
              >Meet Date</label
            >
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('hermesvue1App.citizensMeetings.agenda')" for="citizens-meetings-agenda"
              >Agenda</label
            >
            <input
              type="text"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('hermesvue1App.citizensMeetings.comments')" for="citizens-meetings-comments"
              >Comments</label
            >
            <textarea
              class="form-control"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('hermesvue1App.citizensMeetings.amount')" for="citizens-meetings-amount"
              >Amount</label
            >
            <input
              type="number"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('hermesvue1App.citizensMeetings.quantity')" for="citizens-meetings-quantity"
              >Quantity</label
            >
            <input
              type="number"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('hermesvue1App.citizensMeetings.status')" for="citizens-meetings-status"
              >Status</label
            >
            <input
              type="text"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('hermesvue1App.citizensMeetings.flag')" for="citizens-meetings-flag">Flag</label>
            <input
              type="checkbox"
              class="form-check"
              name="flag"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('hermesvue1App.citizensMeetings.citizen')" for="citizens-meetings-citizen"
              >Citizen</label
            >
