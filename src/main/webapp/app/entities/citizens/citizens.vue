<template>
  <div>
    <h2 id="page-heading" data-cy="CitizensHeading">
      <span v-text="$t('hermesvue1App.citizens.home.title')" id="citizens-heading">Citizens</span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="$t('hermesvue1App.citizens.home.refreshListLabel')">Refresh List</span>
        </button>
        <router-link :to="{ name: 'CitizensCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="$t('hermesvue1App.citizens.home.createLabel')"> Create a new Citizens </span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && citizens && citizens.length === 0">
      <span v-text="$t('hermesvue1App.citizens.home.notFound')">No citizens found</span>
    </div>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="hermesvue1App.citizens.delete.question" data-cy="citizensDeleteDialogHeading" v-text="$t('entity.delete.title')"
          >Confirm delete operation</span
        ></span
      >
      <div class="modal-body">
        <p id="jhi-delete-citizens-heading" v-text="$t('hermesvue1App.citizens.delete.question', { id: removeId })">
