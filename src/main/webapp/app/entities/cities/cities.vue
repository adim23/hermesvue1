<template>
  <div>
    <h2 id="page-heading" data-cy="CitiesHeading">
      <span v-text="$t('hermesvue1App.cities.home.title')" id="cities-heading">Cities</span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="$t('hermesvue1App.cities.home.refreshListLabel')">Refresh List</span>
        </button>
        <router-link :to="{ name: 'CitiesCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="$t('hermesvue1App.cities.home.createLabel')"> Create a new Cities </span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && cities && cities.length === 0">
      <span v-text="$t('hermesvue1App.cities.home.notFound')">No cities found</span>
    </div>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="hermesvue1App.cities.delete.question" data-cy="citiesDeleteDialogHeading" v-text="$t('entity.delete.title')"
          >Confirm delete operation</span
        ></span
      >
      <div class="modal-body">
        <p id="jhi-delete-cities-heading" v-text="$t('hermesvue1App.cities.delete.question', { id: removeId })">
