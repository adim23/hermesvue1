<template>
  <div>
    <h2 id="page-heading" data-cy="ZipCodesHeading">
      <span v-text="$t('hermesvue1App.zipCodes.home.title')" id="zip-codes-heading">Zip Codes</span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="$t('hermesvue1App.zipCodes.home.refreshListLabel')">Refresh List</span>
        </button>
        <router-link :to="{ name: 'ZipCodesCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="$t('hermesvue1App.zipCodes.home.createLabel')"> Create a new Zip Codes </span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && zipCodes && zipCodes.length === 0">
      <span v-text="$t('hermesvue1App.zipCodes.home.notFound')">No zipCodes found</span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('street')">
              <span v-text="$t('hermesvue1App.zipCodes.street')">Street</span>
            ...
            <th scope="row" v-on:click="changeOrder('area')">
              <span v-text="$t('hermesvue1App.zipCodes.area')">Area</span>
            ...
            <th scope="row" v-on:click="changeOrder('fromNumber')">
              <span v-text="$t('hermesvue1App.zipCodes.fromNumber')">From Number</span>
            ...
            <th scope="row" v-on:click="changeOrder('toNumber')">
              <span v-text="$t('hermesvue1App.zipCodes.toNumber')">To Number</span>
            ...
            <th scope="row" v-on:click="changeOrder('country.name')">
              <span v-text="$t('hermesvue1App.zipCodes.country')">Country</span>
            ...
            <th scope="row" v-on:click="changeOrder('region.name')">
              <span v-text="$t('hermesvue1App.zipCodes.region')">Region</span>
            ...
            <th scope="row" v-on:click="changeOrder('city.name')">
              <span v-text="$t('hermesvue1App.zipCodes.city')">City</span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="hermesvue1App.zipCodes.delete.question" data-cy="zipCodesDeleteDialogHeading" v-text="$t('entity.delete.title')"
          >Confirm delete operation</span
        ></span
      >
      <div class="modal-body">
        <p id="jhi-delete-zipCodes-heading" v-text="$t('hermesvue1App.zipCodes.delete.question', { id: removeId })">
